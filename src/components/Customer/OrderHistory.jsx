...
const OrderHistory = () => {
  ...
  const [receiptOrder, setReceiptOrder] = useState(null); // Receipt modal state
      ...
      <div className="space-y-6">
        ...
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 font-semibold">No {selectedStatus !== 'all' ? selectedStatus : ''} orders found</p>
          </div>
        ) : (
